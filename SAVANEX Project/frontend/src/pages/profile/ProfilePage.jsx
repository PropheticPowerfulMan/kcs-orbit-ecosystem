      ...
      {loading ? <div className="card p-6 text-slate-300">Chargement du profil...</div> : <div className="grid gap-6 lg:grid-cols-2">
        <form onSubmit={saveIdentity} className="card space-y-4 p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="block sm:col-span-2"><span className="mb-1 block text-xs text-slate-400">Téléphone</span><InternationalPhoneInput value={identity.phone} onChange={(value) => setIdentity((current) => ({ ...current, phone: value }))} /></label>
          </div>
