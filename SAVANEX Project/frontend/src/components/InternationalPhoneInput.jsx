...
const flagUrl = (country) => `https://flagcdn.com/24x18/${country.toLowerCase()}.png`;

export default function InternationalPhoneInput({ value = "", onChange, className = "", disabled, required, "aria-label": ariaLabel = "Numero de telephone international" }) {
  ...
  const selected = countries.find((item) => item.country === country) || countries[0];
