"""
SAVANEX SMS — Base Django Settings
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='savanex_db'),
        'USER': config('DB_USER', default='savanex_user'),
...
AFRICASTALKING_API_URL = config('AFRICASTALKING_API_URL', default='https://api.africastalking.com/version1/messaging')
AFRICASTALKING_API_KEY = config('AFRICASTALKING_API_KEY', default='')
AFRICASTALKING_USERNAME = config('AFRICASTALKING_USERNAME', default='')
AFRICASTALKING_SENDER = config('AFRICASTALKING_SENDER', default='')
...
KCS_NEXUS_API_URL = config('KCS_NEXUS_API_URL', default='http://localhost:5000')
EDUPAY_API_URL = config('EDUPAY_API_URL', default='http://localhost:4000')
ECOSYSTEM_AUTH_TIMEOUT_SECONDS = config('ECOSYSTEM_AUTH_TIMEOUT_SECONDS', default=5, cast=int)

KCS_NEXUS_AUTH_KEY = config('KCS_NEXUS_AUTH_KEY', default='')
EDUPAY_AUTH_KEY = config('EDUPAY_AUTH_KEY', default='')
EDUSYNC_AUTH_KEY = config('EDUSYNC_AUTH_KEY', default='')
