...
const socialLink = (href: string, label: string, glyph: string, color: string) => `<td style="padding:4px"><a href="${href}" aria-label="${label}" style="display:inline-block;border:0;border-radius:999px;color:#ffffff;text-decoration:none;font-size:11px;font-weight:700;white-space:nowrap"><span style="display:inline-block;width:28px;height:28px;line-height:28px;text-align:center;background:${color};border-radius:999px;color:#ffffff;font-size:10px;font-weight:900">${glyph}</span><span style="display:none;padding:0;vertical-align:middle;color:#ffffff">${label}</span></a></td>`
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:17px auto 0"><tr>${socialLink(FACEBOOK_URL, 'Facebook', '<img src="https://img.icons8.com/color/48/facebook-new.png" width="28" height="28" alt="Facebook" style="display:block;border:0">', 'transparent')}${socialLink(INSTAGRAM_URL, 'Instagram', '<img src="https://img.icons8.com/fluency/48/instagram-new.png" width="28" height="28" alt="Instagram" style="display:block;border:0">', 'transparent')}${socialLink(YOUTUBE_URL, 'YouTube', '<img src="https://img.icons8.com/color/48/youtube-play.png" width="28" height="28" alt="YouTube" style="display:block;border:0">', 'transparent')}</tr></table>
