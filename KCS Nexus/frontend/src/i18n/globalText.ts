...
export const globalFrenchText: PhraseMap = {
  ...
  'AI Tutor': 'Tuteur IA',
  'Student Forum': 'Forum des eleves',
  ...
  'Staff Attendance': 'Presence du personnel',
  Discipline: 'Discipline',
  Courses: 'Cours',
  Finance: 'Finances',
  Media: 'Medias',
  'Parent AI Report': 'Rapport IA parents',
  'Student AI Report': 'Rapport IA eleves',
  ...
  'Academic Overview': 'Vue academique',
  'Overall Grade': 'Note generale',
  'Current GPA': 'Moyenne actuelle',
  'Attendance Rate': 'Taux de presence',
  'Upcoming Assignments': 'Devoirs a venir',
  'Recent Grades': 'Notes recentes',
  ...
  'Suggestion box': 'Boite a suggestions',
  'Send anonymously': 'Envoyer anonymement',
  'Suggestion saved in the confidential channel.': 'Suggestion enregistree dans le canal confidentiel.',
  'Write your suggestion freely...': 'Ecrivez librement votre suggestion...',
  'Import from Super Admin registry': 'Importer depuis le registre super admin',
  'verified students available from the school registry.': 'eleves verifies disponibles dans le registre scolaire.',
  'Manage classes, grades, attendance, assignments, parents, and interventions from one intelligent cockpit.':
    'Gerez les classes, les notes, les presences, les devoirs, les parents et les interventions depuis un seul tableau de bord intelligent.',
  'Students are loaded from the class selected when the course is created.':
    'Les eleves sont charges depuis la classe choisie lors de la creation du cours.',
