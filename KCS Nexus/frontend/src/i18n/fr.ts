const fr = {
  ...
  admissionsPublic: {
    heroBadge: 'Admissions 2026-2027 ouvertes',
    ...
    programsSubtitle: "Places disponibles pour l'année scolaire 2026-2027",
    ...
    keyDatesTitle: 'Temps forts du calendrier scolaire 2026-2027',
    keyDates: [
      { date: '7 sept. 2026', label: 'Premier jour de classe' },
      { date: '9-10 sept. 2026', label: 'Orientation du secondaire' },
      { date: '12 sept. 2026', label: 'Orientation des parents du secondaire (en ligne)' },
      { date: '14 nov. 2026', label: 'Rencontre parents-professeurs' },
      { date: '11 juin 2027', label: 'Dernier jour officiel de classe' },
    ],
  ...
  portalNav: {
    employees: 'Employés',
    dashboard: 'Tableau de bord', incidentReport: "Rapport d’incident", electives: 'Choix des cours électifs', mainTeacherAssignment: 'Affectation des Main Teachers', myGrades: 'Mes notes', assignments: 'Devoirs', timetable: 'Emploi du temps', aiTutor: 'Tuteur IA', studentForum: 'Forum des élèves', messages: 'Messages', myProfile: 'Mon profil',
    performance: 'Résultats scolaires', parentForum: 'Forum des parents', notifications: 'Notifications', calendar: 'Calendrier', fees: 'Frais et paiements', profile: 'Profil', myCourses: 'Mes cours', students: 'Élèves', attendance: 'Présences', gradebook: 'Carnet de notes', reportCards: 'Bulletins scolaires', resources: 'Ressources', reports: 'Rapports', disciplineReport: 'Rapport disciplinaire',
