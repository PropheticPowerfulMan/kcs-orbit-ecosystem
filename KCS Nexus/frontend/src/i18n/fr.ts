const fr = {
  ...
  portalNav: {
    employees: 'Employés',
    dashboard: 'Tableau de bord', incidentReport: "Rapport d’incident", electives: 'Choix des cours électifs', myGrades: 'Mes notes', assignments: 'Devoirs', timetable: 'Emploi du temps', aiTutor: 'Tuteur IA', studentForum: 'Forum des élèves', messages: 'Messages', myProfile: 'Mon profil',
