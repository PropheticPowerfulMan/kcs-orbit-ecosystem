const en = {
  ...
  admissionsPublic: {
    heroBadge: 'Admissions 2026-2027 Now Open',
    ...
    programsSubtitle: 'Spaces available for the 2026-2027 academic year',
    ...
    keyDatesTitle: 'School Calendar Highlights 2026-2027',
    keyDates: [
      { date: 'Sep 7, 2026', label: 'First Day of School' },
      { date: 'Sep 9-10, 2026', label: 'High School Orientation' },
      { date: 'Sep 12, 2026', label: 'High School Parent Orientation (Online)' },
      { date: 'Nov 14, 2026', label: 'Parent-Teacher Conference' },
      { date: 'Jun 11, 2027', label: 'Last Official Day of School' },
    ],
