  ...
  switch (role) {
    case 'student':
      return [
        ...
        { to: '/portal/student/diagnostic', label: 'Diagnostic Test', icon: ClipboardList },
    ...
    case 'staff':
      return [
        ...
        { to: '/portal/staff/diagnostic', label: 'Diagnostic Tests', icon: ClipboardList },
    ...
    case 'admin':
      return [
        ...
        { to: '/admin/diagnostic', label: 'Diagnostic Approval', icon: ClipboardList },
