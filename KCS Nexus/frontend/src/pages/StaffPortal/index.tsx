...
const StaffPortal = () => {
  ...
  const content = segment==='attendance'?<StaffAttendanceSelf/>:segment==='records'?recordsView:segment==='admissions'?admissionsView:segment==='announcements'?announcementsView:segment==='reports'?reportsView:segment==='finance'?financeView:segment==='messages'?messagesView:segment==='permissions'?permissionsView:segment==='settings'?<AccountSettingsPanel roleLabel={roleTitle}/>:dashboard
