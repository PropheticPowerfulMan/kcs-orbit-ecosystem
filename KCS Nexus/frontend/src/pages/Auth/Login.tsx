...
const LoginPage = () => {
  ...
  const requestRecovery = async () => {
    ...
    try {
      ...
      setRecoveryMessage(`Si ce compte existe, un lien sécurisé a été envoyé par ${recoveryChannel === 'sms' ? 'SMS' : 'e-mail'}.`)
