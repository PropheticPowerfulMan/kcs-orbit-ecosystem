...
@page{size:A4 portrait;margin:9mm}*{box-sizing:border-box}:root{--navy:#0f2352;--blue:#004080;--gold:#d8a11d;--pale:#f4f8fc;--line:#cfdae7}
body{margin:0;background:#eaf0f6;color:#17233b;font-family:Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}.sheet{position:relative;width:210mm;min-height:297mm;margin:15px auto;padding:12mm 13mm 10mm;background:#fff;border-top:5mm solid var(--navy);box-shadow:0 20px 60px #10255225;overflow:hidden}.sheet:before{content:"";position:absolute;inset:4mm;border:1px solid #d8a11d77}.watermark{position:absolute;left:50%;top:50%;width:135mm;height:135mm;object-fit:contain;opacity:.04;transform:translate(-50%,-50%) rotate(-9deg);filter:grayscale(1)}.content{position:relative;z-index:1}
header{display:grid;grid-template-columns:26mm 1fr auto;align-items:center;gap:6mm;padding-bottom:5mm;border-bottom:1.5mm solid var(--gold)}.logo-box{width:25mm;height:25mm;padding:1.5mm;border:1mm solid var(--gold);border-radius:50%;background:white;box-shadow:0 0 0 1mm #edf4fb}.logo{width:100%;height:100%;object-fit:contain;border-radius:50%}.school{margin:0;color:var(--blue);font:700 18pt Georgia,serif}.motto{margin:1mm 0 0;color:#64748b;font-size:7pt;font-weight:800;letter-spacing:.16em;text-transform:uppercase}.official{padding:3mm 4mm;background:var(--navy);color:white;border-bottom:1.5mm solid var(--gold);text-align:right}.official b{display:block;color:#f6cc55;font-size:8pt;letter-spacing:.12em}.official span{font-size:6.5pt}
.title{text-align:center;margin:6mm 0 4mm}.title p{margin:0;color:var(--gold);font-size:7pt;font-weight:900;letter-spacing:.25em;text-transform:uppercase}.title h1{margin:1mm 0;color:var(--navy);font:700 20pt Georgia,serif}.identity{display:grid;grid-template-columns:1.5fr 1fr 1fr;gap:3mm;padding:4mm;background:linear-gradient(135deg,#eef6ff,#fff);border-left:1.5mm solid var(--blue)}.field span,.metric span{display:block;color:#65758a;font-size:6pt;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.field b{display:block;margin-top:1mm;color:var(--navy);font-size:9pt}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:2mm;margin:4mm 0}.metric{padding:3mm;border:1px solid var(--line);border-top:.8mm solid var(--gold);text-align:center}.metric b{display:block;margin-top:1mm;color:var(--blue);font-size:11pt}
...
.auth{display:grid;grid-template-columns:27mm 1fr;gap:4mm;align-items:center;margin-top:4mm;padding:3.5mm;border:1px solid var(--line);background:var(--pale)}.qr{width:25mm;height:25mm;padding:1mm;background:white;border:1px solid var(--gold)}.auth h3{margin:0;color:var(--navy);font-size:8pt;letter-spacing:.1em;text-transform:uppercase}.auth-grid{display:grid;grid-template-columns:1fr 1fr;gap:1mm 4mm;margin-top:1.5mm;font-size:6pt}.auth-grid b{color:var(--blue)}.url{grid-column:1/-1;overflow-wrap:anywhere;color:#526477}.signatures{display:grid;grid-template-columns:1fr 1fr 28mm;gap:8mm;align-items:end;margin-top:9mm}.signature{padding-top:2mm;border-top:1px solid #78879a;color:#526477;font-size:6.5pt;font-weight:700}.seal{display:flex;align-items:center;justify-content:center;height:23mm;border:1mm double var(--gold);border-radius:50%;color:var(--blue);font-size:6pt;font-weight:900;text-align:center;transform:rotate(-5deg)}footer{display:flex;justify-content:space-between;gap:5mm;margin-top:5mm;padding-top:2mm;border-top:1px solid var(--gold);color:#68788c;font-size:5.5pt}footer b{color:var(--navy)}
